    ...
    <div id="slideshow">
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <h2>My stationary</h2>
                <strong>Your Stationary shop</strong><br/>
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <h2>My stationary</h2>
                <strong>Your Stationary shop</strong>
                <br/>
                  <!--Edit here
...
<div id="footer-bottom">
    ...
    <div id="credits" class="container_12 clearfix">
        ...
        <p>powered by Drupal
           ...
           , A Project of <a href="https://www.zenopsys.com">Zenopsys Technologies <sup>&copy;</sup></a>
           . Designed by <a href="http://vedavith.uphero.com">Vedavith Ravula </a> and <a href = "#">Asrirtha Surabhi.</a>
         </p>
        </div>
    </div>
    <!-- EOF: #credits -->
